import { CoinFlipGame } from '@/components/arcade/games/coin-flip'
    ...
    return (
        <div className="container mx-auto p-6 max-w-4xl min-h-screen flex flex-col items-center justify-center">
            ...
            <div className="text-center mb-12">
                <h1 className="text-4xl md:text-5xl font-black text-white mb-2 tracking-widest">COIN FLIP</h1>
                <p className="text-zinc-400">50/50 odds. Win 15 PTS or land on edge for 100!</p>
            </div>

            <CoinFlipGame initialPoints={initialPoints} />
        </div>
    )
}
