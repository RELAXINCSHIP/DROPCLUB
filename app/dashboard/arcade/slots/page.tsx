import { SlotMachineGame } from '@/components/arcade/games/slot-machine'
    ...
    return (
        <div className="container mx-auto p-6 max-w-4xl min-h-screen flex flex-col items-center justify-center">
            ...
            <div className="text-center mb-12">
                <h1 className="text-4xl md:text-5xl font-black text-white mb-2 tracking-widest">SLOTS</h1>
                <p className="text-zinc-400">Match symbols to win. Triple 7s = 500 PTS JACKPOT!</p>
            </div>

            <SlotMachineGame initialPoints={initialPoints} />
        </div>
    )
}
